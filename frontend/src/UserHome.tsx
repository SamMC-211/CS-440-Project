    ...
    <>
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          {user.role === "provider" && (
            <CustomHeader text={user.providerName} margin={2} variant="h1" />
          )}
            ...
            <AppBar position="static">
              <Toolbar>
                ...
                <ToggleButtonGroup
                  ...
                  aria-label="Platform"
                  sx={{ "& .MuiToggleButton-root": { borderWidth: 2 } }}
                >
                ...
                <Grid container spacing={6}>
                  ...
                  >
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                      <DatePicker
                        label="After"
                        value={
                          appointmentRange.afterDate
                            ? new Date(appointmentRange.afterDate)
                            : null
                        } // parse string back to Date for picker
                        onChange={(newValue) => {
                          if (newValue) {
                    ...
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                      <DatePicker
                        label="Before"
                        value={
                          appointmentRange.beforeDate
                            ? new Date(appointmentRange.beforeDate)
                            : null
                        } // parse string back to Date for picker
                        onChange={(newValue) => {
                          if (newValue) {
                  ...
                  <Paper elevation={3} sx={{ p: 2, background: "#c1c3c5ff" }}>
                    <SlotList
                      ...
                      onBook={(appt) => bookAppointment(appt)}
                      listTitle="Available Appointments"
                    />
                  </Paper>
                </Grid>
                <Grid size={6}>
